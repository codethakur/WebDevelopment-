...
function checkusername(username)
{
    if(username.length > 7)
    {
        ...
        document.getElementById('username_error').innerHTML='usernmae must be 8 letters long'
    }
...
function checkpasswordsmatch(password , cpassword)
{
    if(password==cpassword && password!='')
    {
        ...
        document.getElementById('cpassword_error').innerHTML='Enter valid cpassword'
    }
